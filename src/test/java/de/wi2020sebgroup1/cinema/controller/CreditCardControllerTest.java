...
public class CreditCardControllerTest {
    ...
    CreditCard getCreditCard() {
    	CreditCard c = new CreditCard("1234-5678-90", "Neunzig", "Mathis", 2022, 6);
    	c.setId(uuid);
    	return c;
    }
    ...
    void testGetById() throws Exception {
        ...
        assertEquals(jt.write(getCreditCard()).getJson(), response.getContentAsString());
    }
    
    @Test
    void testGetByIdException() throws Exception {
        mvc.perform(get("/creditcard/"+new UUID(0, 0))
            .accept(MediaType.APPLICATION_JSON))
    ...
    void testPut() throws Exception{
        ...
        mvc.perform(
            put("/creditcard/add/").contentType(MediaType.APPLICATION_JSON).content(jt.write(getCreditCard()).getJson()))
