...
import de.wi2020sebgroup1.instrumentenverleih.configurationObject.CinemaRoomConfigurationObject;
...
import de.wi2020sebgroup1.instrumentenverleih.exceptions.CinemaNotFoundException;
import de.wi2020sebgroup1.instrumentenverleih.exceptions.CinemaRoomNotFoundException;
import de.wi2020sebgroup1.instrumentenverleih.exceptions.CinemaRoomSeatingPlanNotFoundException;
	...
	public ResponseEntity<Object> addCinemaRoom(@RequestBody CinemaRoomConfigurationObject cinemaRoomConfigurationObject){
		...
		if(cinemaRoomConfigurationObject.cinemaRoomSeatingPlan != null) {
			try {
				...
				return new ResponseEntity<Object>(new CinemaRoomSeatingPlanNotFoundException(cinemaRoomConfigurationObject.cinemaRoomSeatingPlan).getMessage(), HttpStatus.NOT_FOUND);
			}
		}
		...
		if(cinemaRoomConfigurationObject.cinemaID != null) {
			try {
				...
				return new ResponseEntity<Object>(new CinemaNotFoundException(cinemaRoomConfigurationObject.cinemaID).getMessage(), HttpStatus.NOT_FOUND);
			}
		}
