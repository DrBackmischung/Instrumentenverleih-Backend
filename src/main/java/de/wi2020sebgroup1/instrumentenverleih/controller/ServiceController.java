...
import de.wi2020sebgroup1.instrumentenverleih.repositories.ServiceRepository;
...
public class ServiceController {
	...
	@PutMapping("/add")
	public ResponseEntity<Object> add(@RequestBody ServicePortal mi) {
	...
	public ResponseEntity<Object> delete(@PathVariable UUID id){
		...
		try {
			Optional<ServicePortal> o = repo.findById(id);
